...
void RtpAudioStream::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RtpAudioStream::startedPlaying)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RtpAudioStream::processedSecs)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RtpAudioStream::playbackError)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (RtpAudioStream::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RtpAudioStream::finishedPlaying)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject RtpAudioStream::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_RtpAudioStream.data,
      qt_meta_data_RtpAudioStream,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RtpAudioStream::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RtpAudioStream.stringdata0))
        return static_cast<void*>(const_cast< RtpAudioStream*>(this));
