...
void InterfaceToolbarReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InterfaceToolbarReader::received)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InterfaceToolbarReader::finished)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject InterfaceToolbarReader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_InterfaceToolbarReader.data,
      qt_meta_data_InterfaceToolbarReader,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *InterfaceToolbarReader::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_InterfaceToolbarReader.stringdata0))
        return static_cast<void*>(const_cast< InterfaceToolbarReader*>(this));
