...
void DragDropToolBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DragDropToolBar::actionMoved)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DragDropToolBar::newFilterDropped)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject DragDropToolBar::staticMetaObject = {
    { &QToolBar::staticMetaObject, qt_meta_stringdata_DragDropToolBar.data,
      qt_meta_data_DragDropToolBar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DragDropToolBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DragDropToolBar.stringdata0))
        return static_cast<void*>(const_cast< DragDropToolBar*>(this));
