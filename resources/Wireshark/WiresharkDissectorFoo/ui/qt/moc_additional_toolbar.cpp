...
const QMetaObject AdditionalToolbarWidgetAction::staticMetaObject = {
    { &QWidgetAction::staticMetaObject, qt_meta_stringdata_AdditionalToolbarWidgetAction.data,
      qt_meta_data_AdditionalToolbarWidgetAction,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AdditionalToolbarWidgetAction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AdditionalToolbarWidgetAction.stringdata0))
        return static_cast<void*>(const_cast< AdditionalToolbarWidgetAction*>(this));
...
const QMetaObject AdditionalToolBar::staticMetaObject = {
    { &QToolBar::staticMetaObject, qt_meta_stringdata_AdditionalToolBar.data,
      qt_meta_data_AdditionalToolBar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AdditionalToolBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AdditionalToolBar.stringdata0))
        return static_cast<void*>(const_cast< AdditionalToolBar*>(this));
