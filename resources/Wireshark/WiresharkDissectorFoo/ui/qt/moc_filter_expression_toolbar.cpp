...
void FilterExpressionToolBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FilterExpressionToolBar::filterSelected)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FilterExpressionToolBar::filterPreferences)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FilterExpressionToolBar::filterEdit)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject FilterExpressionToolBar::staticMetaObject = {
    { &DragDropToolBar::staticMetaObject, qt_meta_stringdata_FilterExpressionToolBar.data,
      qt_meta_data_FilterExpressionToolBar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FilterExpressionToolBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FilterExpressionToolBar.stringdata0))
        return static_cast<void*>(const_cast< FilterExpressionToolBar*>(this));
