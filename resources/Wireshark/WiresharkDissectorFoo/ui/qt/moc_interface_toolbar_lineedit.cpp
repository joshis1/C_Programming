...
void InterfaceToolbarLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InterfaceToolbarLineEdit::editedTextApplied)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject InterfaceToolbarLineEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_InterfaceToolbarLineEdit.data,
      qt_meta_data_InterfaceToolbarLineEdit,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *InterfaceToolbarLineEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_InterfaceToolbarLineEdit.stringdata0))
        return static_cast<void*>(const_cast< InterfaceToolbarLineEdit*>(this));
