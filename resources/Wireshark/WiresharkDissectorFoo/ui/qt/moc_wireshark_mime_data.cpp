...
const QMetaObject DisplayFilterMimeData::staticMetaObject = {
    { &QMimeData::staticMetaObject, qt_meta_stringdata_DisplayFilterMimeData.data,
      qt_meta_data_DisplayFilterMimeData,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DisplayFilterMimeData::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DisplayFilterMimeData.stringdata0))
        return static_cast<void*>(const_cast< DisplayFilterMimeData*>(this));
...
const QMetaObject ToolbarEntryMimeData::staticMetaObject = {
    { &QMimeData::staticMetaObject, qt_meta_stringdata_ToolbarEntryMimeData.data,
      qt_meta_data_ToolbarEntryMimeData,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ToolbarEntryMimeData::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ToolbarEntryMimeData.stringdata0))
        return static_cast<void*>(const_cast< ToolbarEntryMimeData*>(this));
    return QMimeData::qt_metacast(_clname);
}
