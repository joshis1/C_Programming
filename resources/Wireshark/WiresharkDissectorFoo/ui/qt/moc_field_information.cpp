...
const QMetaObject FieldInformation::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FieldInformation.data,
      qt_meta_data_FieldInformation,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FieldInformation::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FieldInformation.stringdata0))
        return static_cast<void*>(const_cast< FieldInformation*>(this));
    if (!strcmp(_clname, "IDataPrintable"))
        return static_cast< IDataPrintable*>(const_cast< FieldInformation*>(this));
