...
const QMetaObject ExtcapArgument::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ExtcapArgument.data,
      qt_meta_data_ExtcapArgument,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
const QMetaObject ExtArgSelector::staticMetaObject = {
    { &ExtcapArgument::staticMetaObject, qt_meta_stringdata_ExtArgSelector.data,
      qt_meta_data_ExtArgSelector,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ExtArgSelector::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ExtArgSelector.stringdata0))
        return static_cast<void*>(const_cast< ExtArgSelector*>(this));
...
const QMetaObject ExtArgTimestamp::staticMetaObject = {
    { &ExtcapArgument::staticMetaObject, qt_meta_stringdata_ExtArgTimestamp.data,
      qt_meta_data_ExtArgTimestamp,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ExtArgTimestamp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ExtArgTimestamp.stringdata0))
        return static_cast<void*>(const_cast< ExtArgTimestamp*>(this));
    return ExtcapArgument::qt_metacast(_clname);
}
