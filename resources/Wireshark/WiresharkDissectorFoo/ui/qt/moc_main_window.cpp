...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 45: { gboolean _r = _t->addExportObjectsMenuItem((*reinterpret_cast< const void*(*)>(_a[1])),(*reinterpret_cast< void*(*)>(_a[2])),(*reinterpret_cast< void*(*)>(_a[3])));
            if (_a[0]) *reinterpret_cast< gboolean*>(_a[0]) = _r; }  break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::setCaptureFile)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MainWindow::*_t)(capture_file * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::setDissectedCaptureFile)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::displayFilterSuccess)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::closePacketDialogs)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (MainWindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::reloadFields)) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::packetInfoChanged)) {
                *result = 5;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::fieldFilterChanged)) {
                *result = 6;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::filterAction)) {
                *result = 7;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::fieldSelected)) {
                *result = 8;
                return;
            }
        }
        {
            typedef void (MainWindow::*_t)(FieldInformation * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::fieldHighlight)) {
                *result = 9;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::frameSelected)) {
                *result = 10;
                return;
            }
        }
        {
            typedef void (MainWindow::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::captureActive)) {
                *result = 11;
                return;
            }
        }
