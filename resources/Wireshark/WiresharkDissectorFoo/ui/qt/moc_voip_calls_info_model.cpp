...
const QMetaObject VoipCallsInfoModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_VoipCallsInfoModel.data,
      qt_meta_data_VoipCallsInfoModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VoipCallsInfoModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VoipCallsInfoModel.stringdata0))
        return static_cast<void*>(const_cast< VoipCallsInfoModel*>(this));
...
const QMetaObject VoipCallsInfoSortedModel::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_VoipCallsInfoSortedModel.data,
      qt_meta_data_VoipCallsInfoSortedModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VoipCallsInfoSortedModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VoipCallsInfoSortedModel.stringdata0))
        return static_cast<void*>(const_cast< VoipCallsInfoSortedModel*>(this));
