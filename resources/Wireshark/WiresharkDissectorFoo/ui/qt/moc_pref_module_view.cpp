...
QT_MOC_LITERAL(6, 57, 8) // "previous"
...
void PrefModuleTreeView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PrefModuleTreeView::goToPane)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject PrefModuleTreeView::staticMetaObject = {
    { &QTreeView::staticMetaObject, qt_meta_stringdata_PrefModuleTreeView.data,
      qt_meta_data_PrefModuleTreeView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PrefModuleTreeView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PrefModuleTreeView.stringdata0))
        return static_cast<void*>(const_cast< PrefModuleTreeView*>(this));
