...
const QMetaObject DissectorTablesModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_DissectorTablesModel.data,
      qt_meta_data_DissectorTablesModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DissectorTablesModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DissectorTablesModel.stringdata0))
        return static_cast<void*>(const_cast< DissectorTablesModel*>(this));
...
const QMetaObject DissectorTablesProxyModel::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_DissectorTablesProxyModel.data,
      qt_meta_data_DissectorTablesProxyModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DissectorTablesProxyModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DissectorTablesProxyModel.stringdata0))
        return static_cast<void*>(const_cast< DissectorTablesProxyModel*>(this));
