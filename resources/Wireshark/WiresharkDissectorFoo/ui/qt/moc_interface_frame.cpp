...
QT_MOC_LITERAL(15, 213, 29), // "interfaceTreeSelectionChanged"
QT_MOC_LITERAL(16, 243, 14), // "QItemSelection"
QT_MOC_LITERAL(17, 258, 8), // "selected"
QT_MOC_LITERAL(18, 267, 10), // "deselected"
QT_MOC_LITERAL(19, 278, 30), // "on_interfaceTree_doubleClicked"
QT_MOC_LITERAL(20, 309, 5), // "index"
QT_MOC_LITERAL(21, 315, 24), // "on_interfaceTree_clicked"
QT_MOC_LITERAL(22, 340, 16), // "updateStatistics"
QT_MOC_LITERAL(23, 357, 20), // "actionButton_toggled"
QT_MOC_LITERAL(24, 378, 7), // "checked"
QT_MOC_LITERAL(25, 386, 21) // "triggeredIfTypeButton"
    ...
    "interfaceTreeSelectionChanged\0"
...
void InterfaceFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 9: _t->interfaceTreeSelectionChanged((*reinterpret_cast< const QItemSelection(*)>(_a[1])),(*reinterpret_cast< const QItemSelection(*)>(_a[2]))); break;
        case 10: _t->on_interfaceTree_doubleClicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 11: _t->on_interfaceTree_clicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 12: _t->updateStatistics(); break;
        case 13: _t->actionButton_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 14: _t->triggeredIfTypeButton(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InterfaceFrame::showExtcapOptions)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InterfaceFrame::startCapture)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (InterfaceFrame::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InterfaceFrame::itemSelectionChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (InterfaceFrame::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InterfaceFrame::typeSelectionChanged)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject InterfaceFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_InterfaceFrame.data,
      qt_meta_data_InterfaceFrame,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *InterfaceFrame::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_InterfaceFrame.stringdata0))
        return static_cast<void*>(const_cast< InterfaceFrame*>(this));
