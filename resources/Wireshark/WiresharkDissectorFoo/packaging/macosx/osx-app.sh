...
qt_frameworks_dir=$( "/usr/lib/x86_64-linux-gnu/qt5/bin/qmake" -query QT_INSTALL_LIBS )
...
pkgplugin="$bundle/Contents/PlugIns/wireshark/3.0"
...
codesign_file () {
	...
	codesign \
		...
		--options runtime \
		--entitlements "/home/sjoshi/Downloads/wireshark-3.0.1/packaging/macosx/entitlements.plist" \
		--timestamp \
		--verbose \
		"$1"
}
